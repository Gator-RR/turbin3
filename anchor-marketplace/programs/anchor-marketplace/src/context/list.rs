...
use anchor_spl::token_interface::{TransferChecked, transfer_checked, Mint, TokenInterface, TokenAccount};
...
pub struct List <'info> {
    ...
    #[account(
        seeds = [
            b"metadata",                        // Go back to NFT Lecture, what accounts compose it. (token mint, metadata account, edition account, ata? )
